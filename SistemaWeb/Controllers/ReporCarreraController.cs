...
{
    public class ReporCarreraController : Controller
    {
        ...
        public ActionResult BusquedaCarreraHorario(horariogeneracion ph)
        {
            TempData["ph"] = ph;           
            ...
            //  cmd.CommandText = "select c.nombre, d.nombre from dpto d, carrera c where c.cod_dpto = d.cod_dpto and c.cod_carrera = " + carrera +";";
            cmd6.CommandText = "select nombre from carrera where cod_carrera = " + carrer + ";";
    ...
    < a > @row["campo2"].ToString() </ a >< br />
        ...
        */
        ...
        public ActionResult PrintAllEmployee()
        {
            var ph = TempData["ph"];
            TempData.Keep();
            return new ActionAsPdf("BusquedaCarreraHorario", ph) { FileName = "HorarioCarrera.pdf" };
        }
